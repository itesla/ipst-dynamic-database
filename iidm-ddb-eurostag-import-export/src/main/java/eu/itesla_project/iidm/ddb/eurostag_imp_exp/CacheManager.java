...
public class CacheManager {
    ...
    public static synchronized void setDefaultCacheManager(CacheManager defaultCacheManager) {
        CacheManager.defaultCacheManager = defaultCacheManager;
    }

    public static synchronized CacheManager defaultCacheManager() {
        if (defaultCacheManager == null) {
            FileSystem fileSystem = FileSystems.getDefault();
            Path cacheDir = getDirectory(fileSystem, "itools.cache.dir", ".cache", "itools");
            defaultCacheManager = new CacheManager(cacheDir);
        }
    ...
    public static Path getCacheDir() {
        return defaultCacheManager().cacheDir;
    }
}
